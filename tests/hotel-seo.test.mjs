...
const content = {
  ...
  settings: {
    ...
    heroOverlay: 60,
    heroHeight: 720,
    heroCtaLabel: "객실 둘러보기",
    heroCtaHref: "#stay",
    bookingCtaLabel: "예약하기",
    themeAccent: "#2764E7",
    navigation: [{id:"stay",label:"STAY",enabled:true},{id:"experience",label:"EXPERIENCE",enabled:true},{id:"location",label:"LOCATION",enabled:true}],
  },
