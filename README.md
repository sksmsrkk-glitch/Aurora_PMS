...
| 운영 스키마 | 51 tables, 29 application triggers, 79 validated foreign keys, 51 RLS-enabled tables, 14 migrations |
| 자동 테스트 | production build + 36 tests + 보안 회귀·홈페이지 CMS E2E |
