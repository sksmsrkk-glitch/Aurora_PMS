...
| 운영 배포 | 완료 | GitHub, Supabase migration, Vercel Production, Seoul `icn1` Fluid Compute |
...
현재 `vercel.json`은 다음과 같이 동적 함수를 Seoul 한 리전에 배치하고 Fluid Compute를 명시적으로 활성화합니다.
