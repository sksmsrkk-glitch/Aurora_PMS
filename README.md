...
| 운영 스키마 | 51 tables, 29 application triggers, 79 validated foreign keys, 51 RLS-enabled tables, 15 migrations |
| 자동 테스트 | production build + 12 unit/behavior tests + 5 PostgreSQL integration tests + staging E2E |
