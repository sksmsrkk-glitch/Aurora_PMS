...
| 2026-07-23 tenant search platform | migration 0030→0033 순서로 tenant 검색 문서/토큰, 비식별 품질 집계, `btree_gin` 복합 인덱스·중복 인덱스 제거; fuzzy/교정/ranking/keyset/RLS/trigger 행동 테스트와 10,000실 benchmark |
