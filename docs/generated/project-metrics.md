...
| Unit/behavior test | 39 | `tests/*.test.mjs`의 test case |
| PostgreSQL integration test | 11 | `tests/*.integration.mjs`의 test case |
| PMS CSS source | 147,825 bytes / 8 files | root PMS layout imports |
