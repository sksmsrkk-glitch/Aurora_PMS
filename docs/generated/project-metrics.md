...
| 지표 | 현재 값 | 계산 원본 |
| --- | ---: | --- |
| Migration | 33 | `supabase/migrations/*.sql` |
| 런타임 스키마 계약 | `202607220028_finance_rate_snapshot_integrity` | 정렬상 마지막 migration |
...
| Unit/behavior test | 73 | `tests/*.test.mjs`의 test case |
