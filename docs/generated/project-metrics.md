...
| 지표 | 현재 값 | 계산 원본 |
| --- | ---: | --- |
| Migration | 32 | `supabase/migrations/*.sql` |
| 런타임 스키마 계약 | `202607220027_import_pci_rate_override_integrity` | 정렬상 마지막 migration |
...
| Unit/behavior test | 70 | `tests/*.test.mjs`의 test case |
| PostgreSQL integration test | 35 | `tests/*.integration.mjs`의 test case |
| PMS CSS source | 235,573 bytes / 14 files | root PMS layout imports |
