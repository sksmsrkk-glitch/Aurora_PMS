...
| 지표 | 현재 값 | 계산 원본 |
| --- | ---: | --- |
| Migration | 31 | `supabase/migrations/*.sql` |
| 런타임 스키마 계약 | `202607220026_reservation_import_rate_ledger` | 정렬상 마지막 migration |
...
| Unit/behavior test | 69 | `tests/*.test.mjs`의 test case |
