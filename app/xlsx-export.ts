...
export function buildReportWorkbook(report:ExportReport){
  ...
  const files:Record<string,Uint8Array>={
    ...
    "docProps/app.xml":strToU8(`<?xml version="1.0" encoding="UTF-8" standalone="yes"?><Properties xmlns="http://schemas.openxmlformats.org/officeDocument/2006/extended-properties" xmlns:vt="http://schemas.openxmlformats.org/officeDocument/2006/docPropsVTypes"><Application>Talos PMS</Application><Company>주식회사 올마이투어</Company></Properties>`),
