...
const mappings:readonly [RegExp,MappedPmsError][]=[
  ...
  [/room_night_uq|reservation_nights\.property_id/iu,{status:409,error:"해당 객실은 그 날짜에 이미 배정되어 있습니다"}],
  [/RESERVATION_VERSION_CONFLICT_/u,{status:409,error:"다른 사용자가 먼저 변경했습니다. 화면을 새로고침하세요."}],
  [/ROOM_ASSIGNMENT_BLOCKED_/u,{status:409,error:"판매 중지 객실은 배정할 수 없습니다."}],
  [/ROOM_UNASSIGN_IN_HOUSE_/u,{status:409,error:"체크인된 예약은 배정 해제할 수 없습니다"}],
